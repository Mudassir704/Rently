...
import { bookRental, getRentals } from '../services/rentalServise'
...
class Movies extends Component {
  ...
  handleRent = async movie => {
    this.setState({ rentLoading: true });
    ...
    try {
      await bookRental(user._id, movieId);
      ...
      <div className="row">
        ...
        <div className="col">
          ...
          <MoviesTable
            ...
            onValidRent={this.handleValidRent}
          />}
          <Pagination
